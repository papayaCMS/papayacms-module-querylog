...
* @version $Id: admin_querylog.php 39818 2014-05-13 13:15:13Z weinert $
*/
...
class admin_querylog extends base_querylog {
  ...
  * Constructor
  */
  function __construct($paramName = "qlog") {
  ...
  */
   ...
   *
   * @access private
   * @param mixed $params command and parameters to be executed by the links
